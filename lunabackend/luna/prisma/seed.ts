...
async function main() {
  ...
  const rolls = [
    // Классические роллы
    ["Аляска", "Лосось, сливочный сыр, свежий огурец, обжаренный кунжут", 420, 0, null],
    ["Калифорния классическая", "Снежный краб, спелый авокадо, свежий огурец, икра тобико", 390, 0, null],
    ["Калифорния с креветкой", "Тигровая креветка, авокадо, огурец, икра тобико", 450, 0, null],
    ["Калифорния с лососем", "Филе лосося, авокадо, огурец, икра тобико", 440, 0, null],
    ["Калифорния чикен", "Копченая куриная грудка, огурец, кунжут", 350, 0, null],
    ["Филадельфия классическая", "Охлажденный лосось, нежный сливочный сыр, огурец", 480, 0, null],
    ["Унаги филадельфия", "Сливочный сыр, огурец, лосось, копченый угорь, соус унаги, кунжут", 590, 0, null],
    ["Унаги креметте", "Копченый угорь, сливочный сыр Cremette, соус унаги, кунжут", 520, 0, null],
    // Маки
    ["Капа маки", "Классический ролл со свежим огурцом и кунжутом", 180, 1, null],
    ["Кета маки", "Классический ролл с филе кеты", 220, 1, null],
    ["Томато маки", "Ролл со свежим томатом и сливочным сыром", 190, 1, null],
    ["Унаги маки", "Ролл с копченым угрем, соусом унаги и кунжутом", 280, 1, null],
    // Фирменные роллы
    ["Атлантика", "Лосось, сливочный сыр, икра тобико, свежий огурец", 460, 2, "/images/menu/atlantika.svg"],
    ["Восход", "Лосось, икра тобико, сливочный сыр, огурец", 440, 2, null],
    ["Гейша", "Лосось, сливочный сыр, огурец, декорирован икрой", 490, 2, null],
    ["Имбирный", "Маринованный имбирь, сливочный сыр, курица", 380, 2, null],
    ["Империя", "Копченый угорь, лосось, сливочный сыр, авокадо, икра", 620, 2, "/images/menu/imperiya.svg"],
    ["Инари", "Жареный тофу инари, рис, сливочный сыр, овощи", 320, 2, "/images/menu/inari.svg"],
    ["Инь-янь", "Лосось и угорь, белый и черный кунжут", 550, 2, null],
    ["Камелия", "Снежный краб, сливочный сыр, огурец", 410, 2, null],
    ["Кармен", "Сочная курочка, бекон, сливочный сыр, овощи, пикантный соус", 420, 2, null],
    ["Королевский", "Тигровая креветка, лосось, сливочный сыр, икра тобико", 560, 2, null],
    ["Лава лайт", "Снежный краб, сливочный сыр, фирменный соус Лава", 480, 2, null],
    ["Лава с семгой", "Филе семги, сливочный сыр, соус Лава", 520, 2, null],
    ["Небраска", "Копченая курица, сливочный сыр, томат, огурец", 390, 2, null],
    ["Самурай", "Копченый угорь, лосось, сливочный сыр, огурец, соус унаги", 580, 2, null],
    ["Сяки кунсе", "Копченый лосось, сливочный сыр, зеленый лук", 450, 2, null],
    ["Тигровые", "Тигровая креветка в темпуре, сливочный сыр, огурец", 490, 2, "/images/menu/tigrovye.svg"],
    ["Шахмат", "Кусочки лосося и угря в шахматном порядке", 610, 2, "/images/menu/shakhmat.svg"],
    ...
    // Запечённые роллы
    ["Филадельфия запеченная", "Лосось, сливочный сыр, огурец, запечен под сырной шапочкой", 540, 3, "/images/menu/philadelphia-baked.svg"],
    ["Скала", "Запеченный ролл с высокой сырной шапочкой и морепродуктами", 580, 3, "/images/menu/skala.svg"],
    ["Ойси", "Запеченный ролл со сливочным сыром и пикантной шапочкой", 520, 3, "/images/menu/oysi.svg"],
    ["Яки с крабом", "Запеченный ролл с крабом под сырным соусом", 490, 3, "/images/menu/yaki-crab.svg"],
    ["Яки с лососем", "Запеченный ролл с лососем под спайси соусом", 530, 3, "/images/menu/yaki-salmon.svg"],
    ["Яки с мидиями", "Запеченный ролл с мидиями под сырной шапкой", 480, 3, "/images/menu/yaki-mussels.svg"],
    // Горячие роллы
    ["Филадельфия горячая", "Классическая Филадельфия, обжаренная в темпуре", 520, 4, "/images/menu/philadelphia-hot.svg"],
    ["Теплый ролл с креветкой", "Тигровая креветка, сливочный сыр, огурец в темпуре", 490, 4, "/images/menu/warm-shrimp.svg"],
    // Спецпозиции
    ["Суши пицца", "Хрустящая рисовая основа, сливочный сыр, морепродукты, овощи, запечены под сыром", 650, 5, "/images/menu/sushi-pizza.svg"],
    ["Сэндвич ролл", "Сытный суши-сэндвич из риса и нори с плотной начинкой", 420, 5, "/images/menu/sandwich-roll.svg"],
  ];
