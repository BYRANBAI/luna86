        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 p-4">
          <div className="panel w-full max-w-2xl max-h-[90vh] overflow-auto p-6">
            ...
            <div className="mb-5 rounded-lg border border-[#30425a] bg-[#0c1b2d] p-4">
              ...
              <p className="text-sm text-slate-300">{selected.phone} · {selected.phoneVerified ? "номер подтверждён" : "номер не подтверждён"}</p>
            ...
            <div className="mb-5 rounded-lg border border-[#30425a] bg-[#0c1b2d] p-4">
              ...
              {(selected.addresses ?? []).map((a: any) => (
                <p key={a.id} className="border-t border-[#233650] py-2 text-xs text-slate-300">
