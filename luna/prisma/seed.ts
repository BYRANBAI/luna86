...
async function main() {
  ...
  const rolls = [
    // Классические роллы
    ["Аляска", "Лосось, сливочный сыр, свежий огурец, обжаренный кунжут", 420, 0, "/images/menu/alyaska-sushivostok.jpg"],
    ...
    ["Адак шик", "Фирменный ролл — уточнить состав", 520, 2, "/images/menu/adak-shik.svg"],
    ["Кико", "Авторский ролл — уточнить состав", 480, 2, "/images/menu/kiko.svg"],
    ["То-токи", "Фирменный ролл — уточнить состав", 490, 2, "/images/menu/to-toki.svg"],
    ["Япошка", "Авторский ролл — уточнить состав", 510, 2, "/images/menu/yaposhka.svg"],
    // Запечённые роллы
